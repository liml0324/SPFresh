...
namespace SPTAG
{
    ...
    namespace SPANN
    {
        ...
        public:
            ...
            void GetIndexStat(int finishedInsert, bool cost, bool reset) { if (m_options.m_useKV || m_options.m_useSPDK || m_options.m_useFileIO || m_options.m_useLeoFS) m_extraSearcher->GetIndexStats(finishedInsert, cost, reset); }
